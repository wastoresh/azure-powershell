...
online version: https://learn.microsoft.com/powershell/module/az.fileshare/set-azfileshare
schema: 2.0.0
---
...
```
Set-AzFileShare -ResourceGroupName <String> -ResourceName <String> [-SubscriptionId <String>]
