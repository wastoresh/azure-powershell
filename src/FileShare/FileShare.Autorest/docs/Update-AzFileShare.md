...
```
Update-AzFileShare -ResourceGroupName <String> -ResourceName <String> -JsonFilePath <String>
...
### UpdateViaJsonString
```
Update-AzFileShare -ResourceGroupName <String> -ResourceName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
