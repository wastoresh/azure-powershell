...
```
Remove-AzDataLakeGen2AclRecursive [-FileSystem] <String> [[-Path] <String>] -Acl <PSPathAccessControlEntry[]>
 [-StopOnFailure] [-BatchSize <Int32>] [-AsJob] [-Context <IStorageContext>]
...
### -StopOnFailure
Set this parameter to make the transaction stop at first batch that has any path that failed to change Access Control.
Default won't stop.
