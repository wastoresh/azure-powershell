...
online version: https://learn.microsoft.com/powershell/module/az.storage/new-azstorageconnector
schema: 2.0.0
---

# New-AzStorageConnector
...
```
New-AzStorageConnector -AccountName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -DataSourceType <String> -Location <String> -Source <IStorageConnectorSource>
 [-Description <String>] [-State <String>] [-Tag <Hashtable>] [-TestConnection] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.IStorageConnectorSource
Parameter Sets: (All)
Aliases:
