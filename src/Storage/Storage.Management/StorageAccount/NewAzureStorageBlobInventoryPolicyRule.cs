    ...
    public class NewAzureStorageBlobInventoryPolicyRuleCommand : StorageAccountBaseCmdlet
    {
        ...
        [Parameter(Mandatory = true,
            ...
            HelpMessage = "Specifies the fields and properties of the Blob object to be included in the inventory. Valid values include: " +
                        "Name, Creation-Time, Last-Modified, Content-Length, Content-MD5, BlobType, AccessTier, AccessTierChangeTime, AccessTierInferred, Tags, " +
                        "Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, Metadata, LastAccessTime, Tags, Etag, ContentType, ContentEncoding, " +
                        "ContentLanguage, ContentCRC64, CacheControl, ContentDisposition, LeaseStatus, LeaseState, LeaseDuration, ServerEncrypted, Deleted, " +
                        "DeletionId, DeletedTime, RemainingRetentionDays, ImmutabilityPolicyUntilDate, ImmutabilityPolicyMode, LegalHold, CopyId, CopyStatus, " +
                        "CopySource, CopyProgress, CopyCompletionTime, CopyStatusDescription, CustomerProvidedKeySha256, RehydratePriority, ArchiveStatus, " +
                        "XmsBlobSequenceNumber, EncryptionScope, IncrementalCopy, TagCount. 'Name' is a required schemafield. " +
                        "Schema field values 'Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl' are valid only for Hns enabled accounts. " +
                        "'Tags, TagCount' field is only valid for non Hns accounts. If specify '-IncludeSnapshot', will include 'Snapshot'  in the inventory. " +
        ...
        [Parameter(Mandatory = true,
            ...
            HelpMessage = "Specifies the fields and properties of the container object to be included in the inventory. Valid values include: " +
                            ...
                            "Etag, DefaultEncryptionScope, DenyEncryptionScopeOverride, ImmutableStorageWithVersioningEnabled, Deleted, Version, DeletedTime, " +
                            "RemainingRetentionDays. 'Name' is a required schemafield. ")]
