...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    public class NewAzureStorageBlobInventoryPolicyRuleCommand : StorageAccountBaseCmdlet
    {
        ...
        //    HelpMessage = "The rule is for blob inventory.")]
        //[Parameter(Mandatory = false,
        //    ParameterSetName = BlobRuleWithFilterParameterSet,
        //    HelpMessage = "The rule is for blob inventory.")]
        //public SwitchParameter IsBlobRule { get; set; }

        //[Parameter(Mandatory = false,
        //    ParameterSetName = ContainerRuleParameterSet,
        //    HelpMessage = "The rule is for container inventory.")]
        //public SwitchParameter IsContainerRule { get; set; }
