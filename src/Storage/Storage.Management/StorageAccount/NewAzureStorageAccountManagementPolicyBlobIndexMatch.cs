...
{
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "StorageAccountManagementPolicyBlobIndexMatch"), OutputType(typeof(PSTagFilter))]
    public class NewAzureStorageAccountManagementPolicyBlobIndexMatchCommand : StorageAccountBaseCmdlet
    {
