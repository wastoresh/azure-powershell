...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    public class NewAzureStorageAccountCommand : StorageAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                createParameters.AllowSharedKeyAccessForServices = new StorageAccountSharedKeyAccessProperties();
                if (this.allowSharedKeyAccessForBlob != null)
                {   
                    createParameters.AllowSharedKeyAccessForServices.Blob = new ServiceSharedKeyAccessProperties(this.allowSharedKeyAccessForBlob);
                }
                if (this.allowSharedKeyAccessForFile != null)
                {
                    createParameters.AllowSharedKeyAccessForServices.File = new ServiceSharedKeyAccessProperties(this.allowSharedKeyAccessForFile);
                }
                if (this.allowSharedKeyAccessForTable != null)
                {
                    createParameters.AllowSharedKeyAccessForServices.Table = new ServiceSharedKeyAccessProperties(this.allowSharedKeyAccessForTable);
                }
                if (this.allowSharedKeyAccessForQueue != null)
                {
                    createParameters.AllowSharedKeyAccessForServices.Queue = new ServiceSharedKeyAccessProperties(this.allowSharedKeyAccessForQueue);
                }
            }
            if (this.allowStorageConnector != null || this.allowStorageDataShare != null || this.allowCrossTenantDataSharing != null)
            {
                createParameters.DataCollaborationPolicyProperties = new StorageDataCollaborationPolicyProperties(
