    ...
    public class UpdateAzureStorageAccountRuleSetCommand : StorageAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(this.Name, "Update Storage Account NetworkRule"))
            {
                ...
                {
                    throw new System.ArgumentNullException("IPRule, IPv6Rule, VirtualNetworkRule, Bypass, DefaultAction", "Request must specify an account NetworkRule property to update.");
                }
