        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(this.Name, "Set Storage Account"))
            {
                if (this.force || this.AccessTier == null || ShouldContinue("Changing the access tier may result in additional charges. See (http://go.microsoft.com/fwlink/?LinkId=786482) to learn more.", ""))
                {
                    ...
                    if (StorageEncryption || ParameterSetName == KeyvaultEncryptionParameterSet || this.KeyVaultUserAssignedIdentityId != null || this.KeyVaultFederatedIdentityClientId != null)
                    {
                        ...
                        if (this.KeyVaultUserAssignedIdentityId != null || this.KeyVaultFederatedIdentityClientId != null)
                        {
                            ...
                            updateParameters.Encryption.EncryptionIdentity.EncryptionFederatedIdentityClientId = this.KeyVaultFederatedIdentityClientId;
                        }
                    }
