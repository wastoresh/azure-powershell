...
namespace Microsoft.Azure.Commands.Management.Storage.Models
{
    ...
    public class PSBlobServiceProperties
    {
        ...
        [Ps1Xml(Label = "Versioning", Target = ViewControl.Table, ScriptBlock = "if ($_.IsVersioningEnabled -ne $null) {if ($_.IsVersioningEnabled -eq $true){'Enabled'} else {'Disabled'} } else {$null}", Position = 5)]
