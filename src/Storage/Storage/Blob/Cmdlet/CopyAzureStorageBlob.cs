...
namespace Microsoft.WindowsAzure.Commands.Storage.Blob.Cmdlet
{
    ...
    public class CopyAzureStorageBlob : StorageDataMovementCmdletBase
    {
        ...
        [Parameter(HelpMessage = "Block Blob Tier, valid values are Hot/Cool/Archive/Cold. See detail in https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blob-storage-tiers", Mandatory = false)]
