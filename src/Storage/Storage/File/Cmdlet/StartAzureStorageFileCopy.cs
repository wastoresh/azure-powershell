...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    public class StartAzureStorageFileCopyCommand : StorageFileDataManagementCmdletBase
    {
        ...
        [Parameter(Mandatory = false, HelpMessage = "Only applicable to NFS Files. Need specify together with parameter `-Owner` and `-Group`. If not populated, the desination file will have the default Owner and Group.")]
        [ValidateNotNullOrEmpty]
        [PSArgumentCompleter("Source", "Override")]
        public string OwnerCopyMode { get; set; }

        [Parameter(Mandatory = false, HelpMessage = "Only applicable to NFS Files. Need specify together with parameter `-FileMode`. If not populated, the desination file will have the default File Mode.")]
        [ValidateNotNullOrEmpty]
        [PSArgumentCompleter("Source", "Override")]
