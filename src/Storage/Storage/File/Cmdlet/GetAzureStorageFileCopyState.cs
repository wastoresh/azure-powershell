...
namespace Microsoft.WindowsAzure.Commands.Storage.File.Cmdlet
{
    ...
    public class GetAzureStorageFileCopyStateCommand : AzureStorageFileCmdletBase
    {
        ...
        internal void WriteCopyProgress(ShareFileClient file, ShareFileProperties fileProperties, ProgressRecord progress)
        {
            ...
            long bytesCopied = fileProperties.CopyProgress is null ? 0 : Convert.ToInt64(fileProperties.CopyProgress.Split(new char[] { '/' })[0]);
            long totalBytes = fileProperties.CopyProgress is null ? 0 : Convert.ToInt64(fileProperties.CopyProgress.Split(new char[] { '/' })[1]);
            int percent = 0;
