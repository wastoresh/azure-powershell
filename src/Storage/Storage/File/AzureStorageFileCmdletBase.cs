...
namespace Microsoft.WindowsAzure.Commands.Storage.File
{
    ...
    public abstract class AzureStorageFileCmdletBase : StorageCloudCmdletBase<IStorageFileManagement>
    {
        ...
        {
            if(this.Channel != null && this.Channel.StorageContext != null && ((this.Channel.StorageContext.StorageAccount != null && this.Channel.StorageContext.StorageAccount.Credentials.IsToken)|| this.Channel.StorageContext.Track2OauthToken != null))
            {
                return true;
            }
            return false;
