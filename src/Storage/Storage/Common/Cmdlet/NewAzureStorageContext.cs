...
namespace Microsoft.WindowsAzure.Commands.Storage.Common.Cmdlet
{
    ...
    public class NewAzureStorageContext : AzureDataCmdlet
    {
        ...
        [Parameter(Mandatory = false, ParameterSetName = SasTokenParameterSet, HelpMessage = "Required parameter to use with OAuth (Microsoft Entra ID) Authentication for Files. This will bypass any file/directory level permission checks and allow access, based on the allowed data actions, even if there are ACLs in place for those files/directories.")]
        [Parameter(Mandatory = false, ParameterSetName = SasTokenEnvironmentParameterSet, HelpMessage = "Required parameter to use with OAuth (Microsoft Entra ID) Authentication for Files. This will bypass any file/directory level permission checks and allow access, based on the allowed data actions, even if there are ACLs in place for those files/directories.")]
        [Parameter(Mandatory = false, ParameterSetName = SasTokenServiceEndpointParameterSet, HelpMessage = "Required parameter to use with OAuth (Microsoft Entra ID) Authentication for Files. This will bypass any file/directory level permission checks and allow access, based on the allowed data actions, even if there are ACLs in place for those files/directories.")]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            AzureStorageContext context = new AzureStorageContext(account, GetRealAccountName(StorageAccountName), DefaultContext, WriteDebug, this.isOAuth);
