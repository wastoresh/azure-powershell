...
namespace Microsoft.WindowsAzure.Commands.Storage.Model.Contract
{
    ...
    public class StorageBlobManagement : IStorageBlobManagement
    {
        ...
        {
            return blob.StartCopyAsync(new CloudBlockBlob(source), standardBlobTier, sourceAccessCondition, destAccessCondition, options, operationContext, cancellationToken);
        }
