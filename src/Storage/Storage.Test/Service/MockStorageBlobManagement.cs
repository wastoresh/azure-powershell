...
namespace Microsoft.WindowsAzure.Commands.Storage.Test.Service
{
    ...
    public class MockStorageBlobManagement : IStorageBlobManagement
    {
        ...
        public Task<CloudBlob> GetBlobReferenceFromServerAsync(CloudBlobContainer container, string blobName, AccessCondition accessCondition, BlobRequestOptions options, OperationContext operationContext, CancellationToken cmdletCancellationToken, DateTimeOffset? snapshotTime = null, DateTimeOffset? versionId = null)
        {
