...
namespace Microsoft.WindowsAzure.Commands.Storage.Model.Contract
{
    ...
    public interface IStorageFileManagement : IStorageManagement
    {
        ...
        ///  A System.Threading.Tasks.Task object that represents the current operation.
        /// </returns>
        Task DeleteShareAsync(CloudFileShare share, DeleteShareSnapshotsOption deleteSnapshotsOption, AccessCondition accessCondition, FileRequestOptions options, OperationContext operationContext, CancellationToken cancellationToken);
