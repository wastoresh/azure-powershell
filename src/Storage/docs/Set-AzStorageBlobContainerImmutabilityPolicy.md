...
online version: https://docs.microsoft.com/powershell/module/az.storage/set-azstorageblobcontainerimmutabilitypolicy
schema: 2.0.0
---

# Set-AzStorageBlobContainerImmutabilityPolicy
...
```
Set-AzStorageBlobContainerImmutabilityPolicy -AccountName <String> -ContainerName <String>
