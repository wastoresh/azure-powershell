...
online version: https://docs.microsoft.com/powershell/module/az.storage/update-azstorageblobcontainer
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzStorageBlobContainer -InputObject <IStorageIdentity> -BlobContainer <IBlobContainer>
