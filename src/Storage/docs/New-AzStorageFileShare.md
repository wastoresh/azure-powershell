...
online version: https://docs.microsoft.com/powershell/module/az.storage/new-azstoragefileshare
schema: 2.0.0
---
...
```
New-AzStorageFileShare -AccountName <String> -ResourceGroupName <String> -ShareName <String>
 -FileShare <IFileShare> [-SubscriptionId <String>] [-Expand <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzStorageFileShare -InputObject <IStorageIdentity> -FileShare <IFileShare> [-Expand <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-AzStorageFileShare -InputObject <IStorageIdentity> [-Expand <String>]
 [-FileSharePropertyAccessTier <ShareAccessTier>] [-FileSharePropertyEnabledProtocol <EnabledProtocols>]
 [-FileSharePropertyMetadata <Hashtable>] [-FileSharePropertyRootSquash <RootSquashType>]
 [-FileSharePropertyShareQuota <Int32>] [-FileSharePropertySignedIdentifier <ISignedIdentifier[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210801.IFileShare
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Storage.Models.Api20210801.ISignedIdentifier[]
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
