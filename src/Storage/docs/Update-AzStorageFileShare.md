...
online version: https://docs.microsoft.com/powershell/module/az.storage/update-azstoragefileshare
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-AzStorageFileShare -InputObject <IStorageIdentity> -FileShare <IFileShare> [-DefaultProfile <PSObject>]
