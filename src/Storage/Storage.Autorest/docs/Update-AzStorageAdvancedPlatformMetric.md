...
online version: https://learn.microsoft.com/powershell/module/az.storage/update-azstorageadvancedplatformmetric
schema: 2.0.0
---

# Update-AzStorageAdvancedPlatformMetric
...
```
Update-AzStorageAdvancedPlatformMetric -AccountName <String> -ResourceGroupName <String>
...
```
Update-AzStorageAdvancedPlatformMetric -InputObject <IStorageIdentity> [-Enabled]
 [-RuleConfigFilterType <String>] [-RuleConfigFilterValue <String[]>] [-DefaultProfile <PSObject>] [-Confirm]
