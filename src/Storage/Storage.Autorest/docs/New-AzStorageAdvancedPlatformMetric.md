...
online version: https://learn.microsoft.com/powershell/module/az.storage/new-azstorageadvancedplatformmetric
schema: 2.0.0
---

# New-AzStorageAdvancedPlatformMetric
...
```
New-AzStorageAdvancedPlatformMetric -AccountName <String> -ResourceGroupName <String>
