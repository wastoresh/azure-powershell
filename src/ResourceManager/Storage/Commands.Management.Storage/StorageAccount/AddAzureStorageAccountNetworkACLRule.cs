...
{
    [Cmdlet(VerbsCommon.Add, StorageAccountACLRuleNounStr, SupportsShouldProcess = true), OutputType(typeof(PSNetworkACL))]
    public class AddAzureStorageAccountNetworkACLRuleCommand : StorageAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (ShouldProcess(this.Name, "Add Storage Account NetworkACL rules"))
            {
                ...
                if(storageACL == null)
                {
                    storageACL = new StorageNetworkAcls(DefaultAction.Allow, "AzureServices");
                }
                ...
                switch (ParameterSetName)
                {
                    ...
                    case NetworkRuleObjectParameterSet:
                        ...
                        {
                            storageACL.VirtualNetworkRules.Add(PSNetworkACL.ParseStorageNetworkACLVirtualNetworkRule(rule));
                        }
                        break;
                    case IpRuleObjectParameterSet:
                        ...
                        {
                            storageACL.IpRules.Add(PSNetworkACL.ParseStorageNetworkACLIPRule(rule));
                        }
                        break;
                }
