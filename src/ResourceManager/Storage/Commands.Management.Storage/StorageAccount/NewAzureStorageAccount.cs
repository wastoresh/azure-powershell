...
namespace Microsoft.Azure.Commands.Management.Storage
{
    ...
    public class NewAzureStorageAccountCommand : StorageAccountBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (!this.StorageClient.StorageAccounts.CheckNameAvailability(this.Name).NameAvailable.Value)
            {
                throw new System.ArgumentException(string.Format("The storage account named '{0}' is already taken.", this.Name));
            }
