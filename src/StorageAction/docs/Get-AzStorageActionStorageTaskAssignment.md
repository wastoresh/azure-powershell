...
online version: https://learn.microsoft.com/powershell/module/az.storageaction/get-azstorageactionstoragetaskassignment
schema: 2.0.0
---

# Get-AzStorageActionStorageTaskAssignment
...
```
Get-AzStorageActionStorageTaskAssignment -ResourceGroupName <String> -StorageTaskName <String>
