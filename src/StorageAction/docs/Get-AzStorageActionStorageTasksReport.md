...
online version: https://learn.microsoft.com/powershell/module/az.storageaction/get-azstorageactionstoragetasksreport
schema: 2.0.0
---

# Get-AzStorageActionStorageTasksReport
...
```
Get-AzStorageActionStorageTasksReport -ResourceGroupName <String> -StorageTaskName <String>
