...
online version: https://docs.microsoft.com/powershell/module/az.datamover/remove-azdatamoverjobdefinition
schema: 2.0.0
---

# Remove-AzDataMoverJobDefinition
...
### Delete (Default)
```
Remove-AzDataMoverJobDefinition -DataMoverName <String> -Name <String> -ProjectName <String>
...
### DeleteViaIdentity
```
Remove-AzDataMoverJobDefinition -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [-PassThru]
