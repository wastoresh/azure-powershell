...
online version: https://docs.microsoft.com/powershell/module/az.datamover/get-azdatamoverendpoint
schema: 2.0.0
---

# Get-AzDataMoverEndpoint
...
### List (Default)
```
Get-AzDataMoverEndpoint -DataMoverName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzDataMoverEndpoint -DataMoverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDataMoverEndpoint -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
