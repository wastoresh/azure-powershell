...
online version: https://docs.microsoft.com/powershell/module/az.datamover/update-azdatamoverproject
schema: 2.0.0
---

# Update-AzDataMoverProject
...
```
Update-AzDataMoverProject -DataMoverName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDataMoverProject -InputObject <IDataMoverIdentity> [-Description <String>]
