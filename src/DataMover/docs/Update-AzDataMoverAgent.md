...
online version: https://docs.microsoft.com/powershell/module/az.datamover/update-azdatamoveragent
schema: 2.0.0
---

# Update-AzDataMoverAgent
...
```
Update-AzDataMoverAgent -DataMoverName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDataMoverAgent -InputObject <IDataMoverIdentity> [-Description <String>] [-DefaultProfile <PSObject>]
