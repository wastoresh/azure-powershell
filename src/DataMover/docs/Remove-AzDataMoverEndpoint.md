...
online version: https://docs.microsoft.com/powershell/module/az.datamover/remove-azdatamoverendpoint
schema: 2.0.0
---

# Remove-AzDataMoverEndpoint
...
### Delete (Default)
```
Remove-AzDataMoverEndpoint -DataMoverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataMoverEndpoint -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [-PassThru]
