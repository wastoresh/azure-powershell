...
online version: https://docs.microsoft.com/powershell/module/az.datamover/remove-azdatamover
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDataMover -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataMover -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
