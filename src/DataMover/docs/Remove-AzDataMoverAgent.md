...
online version: https://docs.microsoft.com/powershell/module/az.datamover/remove-azdatamoveragent
schema: 2.0.0
---

# Remove-AzDataMoverAgent
...
### Delete (Default)
```
Remove-AzDataMoverAgent -DataMoverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataMoverAgent -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
