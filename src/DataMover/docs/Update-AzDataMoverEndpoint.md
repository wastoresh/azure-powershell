...
online version: https://docs.microsoft.com/powershell/module/az.datamover/update-azdatamoverendpoint
schema: 2.0.0
---

# Update-AzDataMoverEndpoint
...
```
Update-AzDataMoverEndpoint -DataMoverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Property <IEndpointBaseUpdateProperties>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDataMoverEndpoint -InputObject <IDataMoverIdentity> [-Property <IEndpointBaseUpdateProperties>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataMover.Models.Api20210801.IEndpointBaseUpdateProperties
Parameter Sets: (All)
Aliases:
