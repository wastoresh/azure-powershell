...
online version: https://docs.microsoft.com/powershell/module/az.datamover/remove-azdatamoverproject
schema: 2.0.0
---

# Remove-AzDataMoverProject
...
### Delete (Default)
```
Remove-AzDataMoverProject -DataMoverName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataMoverProject -InputObject <IDataMoverIdentity> [-DefaultProfile <PSObject>] [-PassThru]
