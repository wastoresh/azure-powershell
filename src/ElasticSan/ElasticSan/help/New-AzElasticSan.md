...
New-AzElasticSan -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -BaseSizeTiB <Int64>
 ...
 [-PublicNetworkAccess <String>] [-ScaleUpPropertyAutoScalePolicyEnforcement <String>]
 [-ScaleUpPropertyCapacityUnitScaleUpLimitTiB <Int64>] [-ScaleUpPropertyIncreaseCapacityUnitByTiB <Int64>]
 [-ScaleUpPropertyUnusedSizeTiB <Int64>] [-SkuTier <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
