...
### Delete (Default)
```
Remove-AzElasticSanVolume -ElasticSanName <String> -GroupName <String> -Name <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-ForceDeleteSnapshot] [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzElasticSanVolume -InputObject <IElasticSanIdentity> [-ForceDeleteSnapshot]
