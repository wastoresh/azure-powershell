...
online version: https://docs.microsoft.com/powershell/module/az.elasticsan/set-azelasticsanvolume
schema: 2.0.0
---

# Set-AzElasticSanVolume
...
```
Set-AzElasticSanVolume -ElasticSanName <String> -GroupName <String> -Name <String> -ResourceGroupName <String>
